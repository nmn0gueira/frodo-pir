...
MATRIX_HEIGHT_EXP=18
LWE_DIMENSION=3450
ELEMENT_SIZE_EXP=13
PLAINTEXT_SIZE_EXP=16
SECRET_LENGTH_EXP=13
GAUSSIAN_STD_EXP=43
NUM_SHARDS=8
...
PIR_ENV=PIR_MATRIX_HEIGHT_EXP=${MATRIX_HEIGHT_EXP} PIR_LWE_DIM=${LWE_DIMENSION} PIR_ELEM_SIZE_EXP=${ELEMENT_SIZE_EXP} PIR_PLAINTEXT_BITS=${PLAINTEXT_SIZE_EXP} PIR_SECRET_LENGTH_EXP=${SECRET_LENGTH_EXP} PIR_GAUSSIAN_STD_EXP=${GAUSSIAN_STD_EXP} PIR_NUM_SHARDS=${NUM_SHARDS}
...
bench-all:
	${PRELIM} ${PIR_ENV_ALL} PIR_MATRIX_HEIGHT_EXP=18 PIR_PLAINTEXT_BITS=16 PIR_SECRET_LENGTH_EXP=13 PIR_GAUSSIAN_STD_EXP=43 ${CARGO} bench > benchmarks-18.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_MATRIX_HEIGHT_EXP=20 PIR_PLAINTEXT_BITS=14 PIR_SECRET_LENGTH_EXP=14 PIR_GAUSSIAN_STD_EXP=45 ${CARGO} bench > benchmarks-20.txt
	#${PRELIM} ${PIR_ENV_ALL} PIR_MATRIX_HEIGHT_EXP=24 PIR_PLAINTEXT_BITS=12 PIR_SECRET_LENGTH_EXP=15 PIR_GAUSSIAN_STD_EXP=47 ${CARGO} bench > benchmarks-24.txt
