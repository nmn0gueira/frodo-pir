...
This repository contains an implementation of SPIR, a Symmetric PIR scheme derived from FrodoPIR, utilizing noise flooding and hash-based constructions to improve database privacy.
...
* A client and server workflow when using SPIR (10 times).
...
```
docker run --rm -it --entrypoint /bin/bash spir
```
